                            ...
                            if data.get("ok"):
                                for update in data["result"]:
                                    ...
                                    if msg:
                                        ...
                                        # Surface attachments resolved via the real getFile call
                                        # (proves the wire path, not the mock, did the resolution).
                                        for att in msg.attachments:
                                            print(f"  Resolved attachment: {att.kind} -> {att.ref}")
