...
class VectorIndex:
    ...
    def _load(self) -> None:
        if self.index_path.exists() and self.ids_path.exists():
            ...
            # encoding="utf-8" — ids may include unicode source labels
            # (`sandbox:finance_articles/…`); cp1252 default would crash.
    ...
    def persist(self) -> None:
        ...
        self.ids_path.write_text(json.dumps(self._ids, ensure_ascii=False), encoding="utf-8")
